...
export class AlterarSenhaSistemaComponent implements OnInit {
  ...
  public salvar() {
    if(this.formulario.valid) {
      ...
      this.usuarioService.verificarSenha(usuarioLogado.email, senhaAtual).subscribe((httpResponse: any) => {
        if(httpResponse.valido) {
          ...
          this.usuarioService.alterarUsuarioSistema(usuarioLogado.sub, usuario).subscribe(() => {
